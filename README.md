...
A laravel Passport authenticated api that validated a user's email address or phone number and password and returns the users data and passport token.
...
```
# Clone Project
git clone https://github.com/sambayour/clafiya
